...
const Footer = () => (
    <FooterWrapper>
        ...
        <LogoWrapper>
            <PhotoLinks to="/manager-home" height="150px" src={teamLogo} alt="Waltham Forest Logo" />
        </LogoWrapper>
        <SocialMediaWrapper>
            <SocialContent>Check us out on social media</SocialContent>
            <div>
                <PhotoLinks to="/" height="50px" src={twitterLogo} alt="Twitter Logo" />
                <PhotoLinks to="/" height="50px" src={facebookLogo} alt="Facebook Logo" />
                <PhotoLinks to="/" height="50px" src={instagramLogo} alt="Instagram Logo" />
            </div>
        </SocialMediaWrapper>
    </FooterWrapper>
)
