...
const MenuTitle = styled.h1`
    margin-bottom: ${props => props.theme.spacers.indent};
    color: ${({titleColor}) => titleColor ? props => props.theme.colors.primary : props => props.theme.colors.secondary};
`
...
const MenuItems = ({icon, title, titleColor, body, buttonUrl, buttonText}) => {
    return (
        <MenuItem>
